...
- **0.1.8** – Strip every sequence of green and blue output by tightening the sunset path, accent hues, and hue safety rails.
- **0.1.7** – Redesign the color journey to keep every blend out of the green spectrum while weaving in soft pinks and purples for more natural variety.
